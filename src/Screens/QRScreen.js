      ...
      <View style={styles.QRcontainer}>
        ...
        <Modal
          ...
          <Text style={{alignSelf: 'flex-start', color: '#666666'}}>
            {`"Unable to set system brightness" because you have no permission to change the system settings. To solve this issue Open Settings option of your device > Apps & Notifications > App > Search for the YourApplicationName and open the app info by clicking Modify system settings`}
          </Text>
