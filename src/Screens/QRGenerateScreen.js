  ...
  const sendNotification = notifiItem => {
    var message =
      notifiItem.Type === 'Refund'
        ...
        : `${notifiItem.ClientName} payed $${notifiItem.Subtotal}`;
  ...
  return (
    <View style={styles.container}>
      <View style={styles.subContainer}>
        ...
        {role === ADMIN_ROLE && (
          <>
            <Text style={styles.balanceFont}>{`$${parseFloat(
              state.balance,
            ).toFixed(2)}`}</Text>
        ...
        <View style={styles.QRSection}>
          <TouchableOpacity
            ...
            <Text style={styles.scanBtnText}>Show to Redeem</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.scanButtonContainer}
